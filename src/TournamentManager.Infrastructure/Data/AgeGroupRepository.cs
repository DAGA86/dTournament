...
{
    public Task<AgeGroup?> GetAsync(Guid id, CancellationToken cancellationToken = default) => dbContext.AgeGroups.Include(x => x.Tournament).FirstOrDefaultAsync(x => x.Id == id, cancellationToken);
